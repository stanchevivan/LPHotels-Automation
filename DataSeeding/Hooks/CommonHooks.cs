...
namespace DataSeeding.Hooks
{
   // [Binding]
    public class CommonHooks
    {
        ...
        //public CommonHooks(ILpHotelsMainUnitOfWork lpHotelsMainUnitOfWork, ScenarioContext context)
        //{
        ...
        //    var areaToDelete = context.Get<TempArea>(Constants.Data.Area);
        ...
        //    var roleToDelete = context.Get<TempRole>(Constants.Data.Role);
        ...
        //    _lpHotelsMainUnitOfWork.SaveAsync();
            ...
            //    foreach (var model in context)
            //    {
            //        switch (model.GetType().Name)
            //        {
            //            case nameof(Models.CreateShiftModel):
            //                {
            //                    var notes = context.Get<Models.CreateShiftModel>(Constants.Data.Shift).Notes;
            ...
            //                {
            //                    var shiftsToDelete = context.Get<TempShift>(Constants.Data.Shift);
            ...
            //                {
            //                    var assignmenToDelete = context.Get<StaffPayInfo>(Constants.Data.MainAssignment);
            ...
            //                {
            //                    var employeeToDelete = context.Get<TempStaff>(Constants.Data.Employee);
            ...
            //                {
            //                    var jobTitleToDelete = context.Get<JobTitle>(Constants.Data.JobTitle);
