...
namespace Tests.API.Features_and_Steps.Steps
{
    ...
    public class ShiftsSteps
    {
        ...
        //{
        //    if (Session.Get<DataSeeding.Models.CreateShiftModel>(Constants.Data.Shift) != null)
        //    {
        //        var notes = Session.Get<DataSeeding.Models.CreateShiftModel>(Constants.Data.Shift).Notes;
        ...
        //{
        //    var shiftToDelete = Session.Get<Models.DeleteShiftModel>(Constants.Data.ShiftToDelete);
        //    var shiftId = Session.Get<TempShift>(Constants.Data.Shift).ID.ToString();
        //    var locationId = 127554.ToString();////Session.Get<Location>(Constants.Data.Location).ID;
        //    var departmentId = 189847.ToString();//Session.Get<Department>(Constants.Data.Department).ID;
        ...
        //    var employeeId = 171832;//Session.Get<TempStaff>(Constants.Data.Employee).ID;
        //    var shiftId = Session.Get<TempShift>(Constants.Data.Shift).ID.ToString();
        //    var shiftToDelete = new Models.DeleteShiftModel
        //    {
        //        EmployeeId = employeeId,
        ...
        //{
        //    var expectedShift = Session.Get<DataSeeding.Models.DeleteShiftModel>(Constants.Data.Shift);
        ...
        //    var createshift = new DataSeeding.Models.DeleteShiftModel();
        ...
        //            var roleId = Session.Get<TempRole>(Constants.Data.Role).ID;
        //            var createShiftwithInvalidemployee = new DataSeeding.Models.DeleteShiftModel();
        ...
        //            var employeeId = Session.Get<TempStaff>(Constants.Data.Employee).ID;
        //            var createShiftwithInvalidRole = new DataSeeding.Models.DeleteShiftModel();
        ...
        //            var createShiftAnotherOrganisationEmployee = new DataSeeding.Models.DeleteShiftModel();
        ...
        //            var createShiftAnotherOrganisationRole = new DataSeeding.Models.DeleteShiftModel();
        ...
        //{
        //    var shiftToImport = new DataSeeding.Models.DeleteShiftModel();
        //    var departmentId = "";
        //    var locationId ="";
        //    switch (data)
        //    {
        ...
        //        case "CorrectData":
        //            shiftToImport = Session.Get<DataSeeding.Models.DeleteShiftModel>(Constants.Data.Shift);
        ...
        //            var shiftToImportDummyLocCase = new Models.DeleteShiftModel();
        //            var departmentId = 189847.ToString();//Session.Get<Department>(Constants.Data.Department).ID;
        ...
        //            var shiftToImportDummyDepCase = new Models.DeleteShiftModel();
        //            var locationId = 127554.ToString();////Session.Get<Location>(Constants.Data.Location).ID;
        ...
        //        case "InvalidShiftId":
        //            var shiftToImport = Session.Get<Models.DeleteShiftModel>(Constants.Data.Shift);
        ...
        //            var correctShiftToImport = Session.Get<Models.DeleteShiftModel>(Constants.Data.Shift);
